        ...
        switch (act) {
            case ACTION_TYPES.GET_ONE: {
                resActions[`get${serviceName}`] = createAction(
                    ...
                    resolve => (id: number) => resolve({
                        type: `${serviceName.toUpperCase()}_GET`,
                        payload: id,
                    }));
                ...
                resActions[`get${serviceName}AsyncSuccess`] = createAction(
                    ...
                    resolve => (subject: any) => resolve({
                        type: `${serviceName.toUpperCase()}_GET_ASYNC_SUCCESS`,
                        payload: subject,
                    }));
            ...
            case ACTION_TYPES.GET: {
                resActions[`get${entity}`] = createAction(`${entity.toUpperCase()}_GET`,
                    resolve => (params: QueryParamsEntry) => resolve({
                            type: `${entity.toUpperCase()}_GET`,
                            payload: params,
                        }));
                ...
                resActions[`get${entity}AsyncSuccess`] = createAction(
                    ...
                    resolve => (subject: any) => resolve({
                        type: `${entity.toUpperCase()}_GET_ASYNC_SUCCESS`,
                        payload: subject,
                    }));
                break;
            }
            case ACTION_TYPES.ADD: {
                ...
                resActions[`add${serviceName}AsyncSuccess`] = createAction(
                    ...
                    resolve => (subject: any) => resolve({
                        type: `${entity.toUpperCase()}_ADD_ASYNC_SUCCESS`,
                        payload: subject,
                    }));
            ...
            case ACTION_TYPES.EDIT: {
                resActions[`edit${serviceName}`] = createAction(
                    ...
                    resolve => (id: number, data: any, callback: (props: any) => void, hookData?: any) =>
                        resolve({
                            type: `${serviceName.toUpperCase()}_EDIT`,
                            payload: {
                                id,
                                data,
                                callback,
                ...
                resActions[`edit${serviceName}AsyncSuccess`] = createAction(
                    ...
                    resolve => (subject: any) => ({
                        type: `${entity.toUpperCase()}_EDIT_ASYNC_SUCCESS`,
                        payload: subject,
                    }));
            ...
            case ACTION_TYPES.REMOVE: {
                resActions[`delete${serviceName}`] = createAction(
                    ...
                    resolve => (id: number, callback: (props: any) => PromiseLike<any>, hookData?: any) => ({
                        type: `${entity.toUpperCase()}_DELETE`,
                        payload: {
                            data: id,
                            callback,
                            hookData,
                ...
                resActions[`delete${serviceName}AsyncSuccess`] = createAction(
                    ...
                    resolve => (subject: any) => ({
                        type: `${entity.toUpperCase()}_DELETE_ASYNC_SUCCESS`,
                        payload: subject,
                    }));
